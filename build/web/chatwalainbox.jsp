...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
      ...
      .right-header-contentChat{
        overflow-y: scroll; 
        height: 500px;               /*This affects the scroll bar*/
	...
	<div class="container main-section" style="width: 100%;">
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
				...
				<div class="left-chat" style="height: 455px;">
                        ...
                        <%
                            ResultSet rst1 = dbObj.viewAll();
                            String user1 = null;
                            String user1_name = null;
                            if(rst1.next())
                            {
                                user1 = rst1.getString(4);
                                if(user1.equals(username))
                                    rst1.next();
                                user1 = rst1.getString(4);
                                user1_name = rst1.getString(2);
            ...
            <div class="col-md-12 right-header-contentChat" style="height:400px;">
                <ul>
                        <%
                            ResultSet rst3 = dbObj.fetchAllTextsOfThisUser(username, user1);
                           // int variable = 1;
                            if(rst3 != null)
                            {
                                while(rst3.next())
                    ...
                    <li>
                        <div class="rightside-left-chat">
                                <span><i class="fa fa-circle" aria-hidden="true"></i>
                                    <%=sender%>&nbsp;<small><%=time%>,<%=date%></small> </span><br><br>
                                <p><%=message%>.</p>
                        </div>
                    </li>
                        <%
        ...
        <div class="row">
            <div  style="background-color:black;" class="right-chat-textbox">
                    <form method="post" action="sendtext.jsp?user=<%=user1%>">
